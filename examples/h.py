...
pyplot.plot(T1, hsat_liquid1/1e5, 'k-', linewidth=2)
pyplot.plot(T1, hsat_vapor1/1e5, 'k-', linewidth=2)
pyplot.plot(T1[-1], iapws1995.hc/1e5, 'ko')
pyplot.plot(T2, hsat_ice2/1e5, 'k-', linewidth=2)
pyplot.plot(T2, hsat_vapor2/1e5, 'k-', linewidth=2)

pyplot.text(300, 22, 'Vapor')
pyplot.text(400, 10, 'Liquid')
pyplot.text(175, -3, 'Ice')

pyplot.xlabel(r'Temperature ($\mathregular{^{\circ}C}$)', fontsize=14)
pyplot.ylabel(r'($\mathregular{\times 10^5}$ J/kg)', fontsize=14)
