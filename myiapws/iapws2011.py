...
"""IAPWS 2011 melting and sublimation curves for ordinary water substance.
...
def pmelt_ice_Ih(T):
    """Ice Ih melting pressure (Pa) at temperature T (K).
    251.165 <= T <= 273.16 K"""
    ...
    return (1. + sum(a[i]*(1.-theta**b[i]) for i in range(3))) * pstar


def pmelt_ice_III(T):
    """Ice III melting pressure (Pa) at temperature T (K).
    251.165 <= T <= 256.164"""
    ...
    return (1. - 0.299948*(1.-theta**60)) * pstar * 1.e6


def pmelt_ice_V(T):
    """Ice V melting pressure (Pa) at temperature T (K).
    256.164 <= T <= 273.31"""
    ...
    return (1. - 1.18721*(1.-theta**8)) * pstar * 1.e6


def pmelt_ice_VI(T):
    """Ice VI melting pressure (Pa) at temperature T (K).
    273.31 <= T <= 355"""
    ...
    return (1. - 1.07476*(1.-theta**4.6)) * pstar * 1.e6


def pmelt_ice_VII(T):
    """Ice VII melting pressure (Pa) at temperature T (K).
    355 <= T <= 715"""
    ...
    return numpy.exp((0.173683e1*(1.-1./theta)
                      ...
                      + 0.806106e-7*(1.-theta**22))) * pstar * 1.e6


def psubl_ice_Ih(T):
    """Ice Ih sublimation pressure (Pa) at temperature T (K).
    50 <= T <= 273.16 K"""
    ...
    return numpy.exp(1./theta*sum(a[i]*theta**b[i] for i in range(3))) * pstar
